	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
					...
					<ul class="nav pull-right">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="{{route('profile.edit')}}"><i class="halflings-icon user"></i> Profile</a></li>
								<li><a href="javascript:void(0)" onclick="document.getElementById('logut_form').submit()"><i class="halflings-icon off"></i> Logout</a></li>
							</ul>
						</li>
						<!-- end: User Dropdown -->
					</ul>
				...
				<!-- end: Header Menu -->
                <form id="logut_form" action="{{route('logout')}}" method="post">
                    @csrf
					...
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
							...
							<li><a class="submenu" href="{{route('admin.add-notice')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add Notice</span></a></li>
								...
								<li><a class="submenu" href="{{route('admin.index.timeline')}}"><i class="icon-file-alt"></i><span class="hidden-tablet">Timeline</span></a></li>
							</ul>
                        </li>
                        ...
                        <li>
                            <a class="dropmenu" href="#"><i class="icon-user"></i><span class="hidden-tablet"> Students</span></a>
                            <ul>
                                <li><a class="submenu" href="{{route('student.rpl.index')}}"><i class="icon-user"></i><span class="hidden-tablet"> RPL</span></a></li>
                                <li><a class="submenu" href="{{route('student.index')}}"><i class="icon-user"></i><span class="hidden-tablet"> Regular</span></a></li>
                            </ul>
                        </li>
                        <li>
